...
const routes = [
  {
    ...
    children: [
      ...
      { path: 'category', name: 'Category', meta: { name: '咨询分类' }, component: () => import('../views/manager/Category') },
      { path: 'news', name: 'News', meta: { name: '咨询信息' }, component: () => import('../views/manager/News') },
